        ...
        <div className="footer-container">
          <div className="footer-content">
            ...
            <div className="brand-section">
              <h1 className="brand-title">CHAI BUNK CAFÉ DBpura</h1>
            </div>
            ...
            <div className="franchise-section">
              <h2 className="franchise-title">For Enquiry</h2>
              
              <div className="contact-info">
                <div className="contact-item">
                  <span className="contact-label">Call Us:</span>
                  <a href="tel:+918885647099" className="contact-link">+91 01010101010</a>
                </div>
                
                <div className="contact-item">
                  <span className="contact-label">Email Us:</span>
                  <a href="mailto:sales@chaibunk.com" className="contact-link">fake@gmail.com</a>
                </div>
              </div>
            </div>
            ...
            {/* <div className="copyright-section">
              <p className="copyright-text">All Copyrights Reserved To</p>
              <p className="company-name">SANAHAYA Food and Beverages Pvt Ltd</p>
